        ...
        <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-8">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <a href="#" className="flex items-center gap-2 px-5 py-3 rounded-full bg-black/5 hover:bg-pink-100 transition-all duration-300 hover:scale-105" style={{ color: '#1a1a1a' }}>
